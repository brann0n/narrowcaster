...
import nl.ba99.narrowcaster.models.EntityId;
...
public abstract class AbstractAPIService<Repository extends JpaRepository<Entity, Long>, DTO, Entity extends EntityId> implements APIService<DTO> {
     ...
     */
    public AbstractAPIService(Repository repo, MappingUtility mapper, Class<DTO> dto, Class<Entity> entity, LogService logService) {
        this.repo = repo;
        this.mapper = mapper;
        this.dtoType = dto;
