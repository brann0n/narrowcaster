package nl.ba99.narrowcaster.controllers.logic;

import nl.ba99.narrowcaster.services.logic.APIService;
...
public abstract class AbstractAPIController<Service extends APIService<DTO>, DTO> implements APIController<DTO> {
    protected final Service service;

    public AbstractAPIController(@SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection") Service service) {
